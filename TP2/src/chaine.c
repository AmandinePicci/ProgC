...
int main() {
	...
	switch (questionNumero){
		case 1 : {	//Calcule le nombre de caractères dans une chaine
		...
		case 2 : {	//Copie une chaine de caractère dans une autre
		...
		case 3 : {	//Concatène deux chaines
			...
			for (i=0 ; i<k ; i+=1){		// on met chaine 1 dans chaine 3
				chaine3[i]=chaine1[i];}
			int j=i;
			for (j=i ; j<k+l ; j+=1){	//puis on rajoute chaine 2 dans chaine 3
